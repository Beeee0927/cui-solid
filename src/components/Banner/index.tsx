          ...
          <div class="cm-banner-content">
            ...
            <div class="cm-banner-content-body">
              <Show when={props.title}>
                <div class="cm-banner-title">{props.title}</div>
              </Show>
              <Show when={slots.default}>
                <div class="cm-banner-desc">{slots.default}</div>
              </Show>
            </div>
          </div>
          <Show when={props.closeIcon !== null}>
            <span class="cm-banner-close" onClick={onClickClose}>
              {props.closeIcon ?? <FeatherX />}
            </span>
          </Show>
        </div>
        <Show when={slots.extra}>
          <div class="cm-banner-extra">{slots.extra}</div>
        </Show>
      </div>
    </Show>
  )
