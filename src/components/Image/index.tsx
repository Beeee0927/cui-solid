...
export function Image(props: ImageProps) {
  ...
  return (
    <div class="cm-image" ref={wrap} style={imageStyles()}>
      <Show when={loading()}>
        <div class="cm-image-placeholder">
          <Show when={!props.placeholder} fallback={props.placeholder}>
            ...
            >
              ...
              />
              <path
                d="M640 396.8m-51.2 0a51.2 51.2 0 1 0 102.4 0 51.2 51.2 0 1 0-102.4 0Z"
                fill="#82D2F7"
                p-id="5340"
              />
              <path
                d="M479.6416 472.8832l88.448 176.896A64 64 0 0 1 510.848 742.4H333.952a64 64 0 0 1-57.2416-92.6208l88.448-176.896a64 64 0 0 1 114.4832 0z"
                fill="#046EA7"
                p-id="5341"
              />
              <path
                d="M674.3424 555.0976l65.8688 131.7248A38.4 38.4 0 0 1 705.8688 742.4H574.1312a38.4 38.4 0 0 1-34.3424-55.5776l65.8688-131.7248a38.4 38.4 0 0 1 68.6848 0z"
                fill="#FCCF0A"
              />
            </svg>
          </Show>
      ...
      <Show when={props.preview}>
        <ImagePreview
          ...
          initIndex={props.previewIndex || 0}
          maskClosable={props.maskClosable}
          onClose={handleClose}
          visible={[previewVisible, setPreviewVisible]}
