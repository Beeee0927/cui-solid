...
export function Result(props: ResultProps) {
  ...
  return (
    <div classList={classList()} {...rest}>
      <Show when={icon}>
        <div class="cm-result-icon">{icon}</div>
      </Show>
      <Show when={local.title}>
        <div class="cm-result-title">{local.title}</div>
      </Show>
      <Show when={local.subTitle}>
        <div class="cm-result-subtitle">{local.subTitle}</div>
      </Show>
      <Show when={local.extra}>
        <div class="cm-result-extra">{local.extra}</div>
      </Show>
      <Show when={local.desc}>
        <div class="cm-result-desc">{local.desc}</div>
      </Show>
    </div>
  )
}
