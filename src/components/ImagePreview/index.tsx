...
export function ImagePreview(props: ImagePreviewProps) {
  ...
  const leftClasses = () => ({
    'cm-image-preview-arrow-left': true,
    'cm-image-preview-arrow-disabled': hasLeftSwitchEnd()
  })
  const rightClasses = () => ({
    'cm-image-preview-arrow-right': true,
    'cm-image-preview-arrow-disabled': hasRightSwitchEnd()
  })
