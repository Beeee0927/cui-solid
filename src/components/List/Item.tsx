...
export function Item(props: ListItemProps) {
  ...
  const classList = () =>
    useClassList(props, 'cm-list-item', {
  ...
  return (
    <div classList={classList()} style={props.style} onClick={onClick}>
      <div class="cm-list-item-main">
        <div class="cm-list-item-meta">
          {props.avatar ? (
            <div class="cm-list-item-avatar">{props.avatar}</div>
          ) : null}
        ...
        <div class="cm-list-item-content">{props.children}</div>
      </div>
      {props.actions ? (
        <ul class="cm-list-item-addon">{props.actions}</ul>
      ) : null}
    </div>
  )
}
