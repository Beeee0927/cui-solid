...
export function RateItem(props: RateItemProps) {
  ...
  return (
    <div classList={className()}>
      <span
        onMouseEnter={props.onMouseEnter?.bind(null, props.index + 1)}
        onClick={props.onClickStar?.bind(null, props.index + 1)}
      >
        {props.icon}
      </span>
      {props.allowHalf ? (
        <span
          ...
          onMouseEnter={props.onMouseEnterHalf?.bind(null, props.index + 0.5)}
