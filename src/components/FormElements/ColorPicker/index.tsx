...
export function ColorPicker(props: ColorPickerProps) {
        ...
        <div class="cm-color-picker-confirm">
          <Space dir="h">
            <Input
              ...
              value={[confirmVal, setConfirmVal]}
            />
            <Button size="small" type="default" onClick={onClear}>
              清除
            </Button>
  ...
  return (
      ...
      fallback={
        <div classList={classList()} style={props.style}>
          <Dropdown
            ...
            menu={<div class="cm-color-picker-wrap">{renderMain()}</div>}
          >
            <Value
              disabled={props.disabled}
              size={props.size}
    ...
    >
      <div classList={inlineClassList()}>{renderMain()}</div>
    </Show>
  )
}
