...
export function TimeRange(props: any) {
  ...
  return (
    <>
      <TimePane
        value={val1()}
        header={local.header[0]}
        footer={local.footer && local.footer.length && local.footer[0]}
        {...others}
        name="start"
      />
      <TimePane
        value={val2()}
        header={local.header[1]}
        footer={local.footer && local.footer.length && local.footer[1]}
        {...others}
        name="end"
      />
    </>
