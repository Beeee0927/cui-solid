...
export interface DividerProps
  extends Omit<JSX.HTMLAttributes<HTMLDivElement>, 'dir'> {
  dir?: 'h' | 'v'
  align?: 'left' | 'right'
  theme?:
    | string
...
export function Divider(props: DividerProps) {
  ...
  return (
    <div classList={classList()} style={aStyle()} {...rest}>
      {local.children ? (
        <span class="cm-divider-text" style={textStyle()}>
          {local.children}
        </span>
      ) : null}
    </div>
