    ...
    if (opened() && nextElementSibling) {
      ...
      if (props.position) {
        ...
        Object.assign(pos, props.style || {}, {
          '--cui-dropdown-background-color': isColor(props.theme)
            ? props.theme
            : '',
  ...
  onMount(() => {
    ...
    if (nextElementSibling) {
      ...
      if (trigger === 'click' || trigger === 'custom') {
        ...
        if (trigger === 'click') {
          const other = props.handler
            ? nextElementSibling.querySelectorAll(props.handler)
            : nextElementSibling
      ...
      <Show
        ...
        fallback={
          <DropdownContext.Provider
            value={{ onSelect, gradient: props.gradient, color: props.color }}
          >
            <div
              style={posStyle()}
              classList={classList()}
