...
const TableStyleLayoutContext = createContext<TableStyleLayoutContextProps>({
  labelWidth: 100
})

export const useTableStyleLayoutContext = () =>
  useContext(TableStyleLayoutContext)
...
export function TableStyleLayout(props: TableStyleLayoutProps) {
  ...
  return (
    <TableStyleLayoutContext.Provider
      value={{ labelWidth: props.labelWidth || 100 }}
    >
