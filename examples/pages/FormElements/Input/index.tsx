        ...
        <Space dir="v" size={32}>
          ...
          <Space id="input_placeholder" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">placeholder</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                使用 placeholder 的样例
              </Paragraph>
          ...
          <Space id="input_prefix" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">前缀后缀</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                使用<Text code>prefix</Text> 可以给Input添加前缀， 使用
                <Text code>suffix</Text>属性可添加后缀
              </Paragraph>
          ...
          <Space id="input_append" dir="v">
            <Card bordered>
              ...
              />
              <Divider align="left">
                <Text type="primary">追加</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                使用<Text code>prepend</Text> 可添加前追加， 使用
                <Text code>append</Text>属性可添加后追加
              </Paragraph>
          ...
          <Space id="input_size" dir="v">
            <Card bordered>
              <Space dir="h">
                <Input clearable size="large" />
                <Input clearable />
                <Input clearable size="small" />
              </Space>
              <Divider align="left">
                <Text type="primary">尺寸</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                <Text code>size</Text> 属性支持 <Text code>small</Text>{' '}
                <Text code>large</Text> 默认尺寸中
              </Paragraph>
