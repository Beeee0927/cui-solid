  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Timepicker 时间选择</Title>
          ...
          <Space id="time_disable_time" dir="v">
            <Card bordered>
              <Timepicker
                disabledTime={(num: number, type: string) => {
                  if (
