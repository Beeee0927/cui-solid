...
export default function DatepickerPage() {
  const [value, setValue] = createSignal<Date[]>([
    ...
    dayjs('2023-05-15').toDate()
  ])
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Datepicker 日期选择</Title>
          ...
          <Space id="date_dateTime" dir="v">
            <Card bordered>
              <Datepicker
                clearable
                type="dateTime"
                value="2023-04-05 15:35:30"
              />
              <Divider align="left">
                <Text type="primary">日期时间</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
