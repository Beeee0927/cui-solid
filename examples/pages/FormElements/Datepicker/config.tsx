...
export const propsData = [
  ...
  {
    name: 'align',
    desc: '下拉位置bottomLeft|bottomRight',
    type: 'string',
    default: 'bottomRight'
  },
  ...
  {
    name: 'disabledDate',
    desc: '禁用日期的回调函数，参数Date',
    type: 'Function',
    default: ''
  },
  {
    name: 'type',
    desc: '日期类型 支持 dateRange|monthRange|month|dateTime|dateTimeRange',
    type: 'string',
    default: 'date'
  },
