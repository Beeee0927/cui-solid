  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>ColorPicker 颜色选择器</Title>
          ...
          <Space id="cp_recommand" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">颜色预设</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                开启属性 recommend 可以显示推荐的颜色预设，或设置属性 colors
                来自定义预设颜色。
              </Paragraph>
