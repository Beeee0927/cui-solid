...
export default function SelectPage() {
  ...
  const remoteQuery = (query: string) => {
    ...
    const arr = new Array(10)
      .fill(0)
      .map((_, index) => ({ value: query + index, label: query + index }))
    setFilteredData(arr)
    setLoading(false)
  }
  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Select 选择框</Title>
            ...
            <Card bordered>
              <Space>
                ...
                <Select
                  ...
                  filter
                  multi
                  remoteMethod={remoteQuery2}
                  loading={loading()}
                >
                  <For each={filteredData2()}>
                    {(item) => {
                      return <Option value={item.value} label={item.label} />
                    }}
                  </For>
                  ...
                  header={
                    <div style={tabWrapper}>
                      <For each={tabOptions}>
                        {(item) => {
                          const style = () =>
                            item.itemKey === key() ? tabActiveStyle : tabStyle
                          return (
                            <div
                              style={style()}
          ...
          <Space id="select_trigger" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">triggerRender</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                triggerRender
              </Paragraph>
          ...
          <Space id="select_trigger" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">先设置值再更新数据</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                triggerRender
              </Paragraph>
