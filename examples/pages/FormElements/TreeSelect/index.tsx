  ...
  for (let i = 0; i < 3; i++) {
    ...
    for (let j = 0; j < 3; j++) {
      ...
      for (let k = 0; k < 3; k++) {
        d.push({
          id: `${i + 1}_${j + 1}_${k + 1}`,
          title: `node_${i + 1}_${j + 1}_${k + 1}`
        })
      }
      c.push({
        id: `${i + 1}_${j + 1}`,
        title: `node_${i + 1}_${j + 1}`,
        children: d,
        disabled
      })
    }
  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>TreeSelect 树选择</Title>
          ...
          <Space id="tree_relation" dir="v">
            <Card bordered>
              ...
              />
              <Divider align="left">
                <Text type="primary">多选非级联</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                checkRelation 支持 unRelated (非级联) 和 related (级联) 默认
                related
              </Paragraph>
