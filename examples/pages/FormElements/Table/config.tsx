...
export const propsData = [
  ...
  {
    name: 'onCheckedAll',
    desc: '全选事件, 所有选中的数据data',
    type: 'Function',
    default: ''
  },
  {
    name: 'onSort',
    desc: '排序事件 column, sotyType',
    type: 'Function',
    default: ''
  },
...
export const columnData = [
  ...
  {
    name: 'render',
    desc: '自定义渲染函数， v, column, row',
    type: 'Function',
    default: ''
  },
  {
    name: 'type',
    desc: '字段类型 index, checkbox、 expend',
    type: 'string',
    default: ''
  },
  ...
  {
    name: 'ellipsis',
    desc: '字段超过宽度使用省略号显示，内容不换行',
    type: 'boolean',
    default: ''
  },
  {
    name: 'tooltip',
    desc: '字段超过宽度使用省略号显示，内容不换行，鼠标滑过气泡显示完整内容',
    type: 'boolean',
    default: ''
  },
  {
    name: 'tooltipAlign',
    desc: 'popover的align属性',
    type: 'string',
    default: ''
  },
  {
    name: 'tooltipTheme',
    desc: 'popover的theme属性',
    type: 'string',
    default: ''
  },
  {
    name: 'tooltipMaxWidth',
    desc: 'popover的内容的最大宽度',
    type: 'number',
    default: ''
  },
  {
    name: 'tooltipStyle',
    desc: 'popover的内容的自定义样式',
    type: 'any',
    default: ''
  },
  ...
  {
    name: 'fixed',
    desc: '固定列的位置 left | right',
    type: 'string',
    default: ''
  },
  {
    name: 'tree',
    desc: '改列为树状字段， 展示展开收缩按钮',
    type: 'boolean',
    default: ''
  }
]
