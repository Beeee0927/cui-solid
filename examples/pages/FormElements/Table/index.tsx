...
export default function TablePage() {
  ...
  const columns2 = [
    ...
    { name: 'date', title: '日期', width: '200px' },
    {
      ...
      title: '操作',
      width: '150px',
      render: (v: any, column: any, row: any) => {
        return (
          <Space>
        ...
        <Space dir="v" size={32}>
          ...
          <Space id="table_highlight" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">行高亮</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                添加 highlight 选择一行的时候可以高亮显示,
                可通过引用的clearSelect方法进行清除
              </Paragraph>
          ...
          <Space id="table_checkbox" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">选择框</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                column 中设置type 为checkbox可以添加选择列,
                通过render函数可自定义渲染内容
                <br />
          ...
          <Space id="table_sort" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">排序</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                通过给 columns 数据的项，设置 sort:
                true，即可对该列数据进行排序。
                <br />
                通过给某一列设置 sortType 可以在初始化时使用排序。
                <br />
                如果使用远程排序，可以设置 sortable:
                'custom'，然后在触发排序事件 onSort
                后，进行远程排序，并手动设置新的 data
              </Paragraph>
          ...
          <Space id="table_resize" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">拖拽列宽</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                给某一列设置属性 resize 为 true，可以拖拽调整该列的宽度，需开启
                border 属性，且该列设置了 width 属性。
              </Paragraph>
          ...
          <Space id="table_largedata" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">大列表</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                当表格数据量较大时为了提升渲染性能，可以使用虚拟列表 通过指定
                virtual 属性并设置 height，即可高性能渲染表格
                <br />
              </Paragraph>
