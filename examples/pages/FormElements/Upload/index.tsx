  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Upload 上传</Title>
          <Space id="upload_base" dir="v">
            <Card bordered>
              <Upload
                action="https://cqb325.gitee.io/cui-solid-doc/"
                name="file"
              ...
              >
                <Button icon={<FeatherUpload />} type="primary">
                  Upload Files
                </Button>
              </Upload>
              <Divider align="left">
          ...
          <Space id="upload_drag" dir="v">
            <Card bordered>
              ...
              <Paragraph type="secondary" spacing="extended">
                type="drag" 可以支持拖拽上传， 上传的数据使用data传入，
                自定义请求头通过 headers 参数传输
              </Paragraph>
