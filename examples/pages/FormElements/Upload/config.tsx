...
export const propsData = [
  ...
  {
    name: 'beforeUpload',
    desc: '上传文件之前的钩子，参数为上传的文件，若返回 false 或者 Promise 则停止上传',
    type: 'Function',
    default: ''
  },
  {
    name: 'format',
    desc: '支持的文件类型，与 accept 不同的是，format 是识别文件的后缀名',
    type: 'string[]',
    default: ''
  },
  ...
  {
    name: 'onProgress',
    desc: '文件上传时的钩子，返回字段为 event, file, fileList',
    type: 'Function',
    default: ''
  },
  {
    name: 'onSuccess',
    desc: '文件上传成功时的钩子，返回字段为 response, file, fileList',
    type: 'Function',
    default: ''
  },
  {
    name: 'onError',
    desc: '文件上传失败时的钩子，返回字段为 error, file, fileList',
    type: 'Function',
    default: ''
  },
  {
    name: 'onRemove',
    desc: '文件列表移除文件时的钩子，返回字段为 file, fileList',
    type: 'Function',
    default: ''
  },
  {
    name: 'onPreview',
    desc: '点击已上传的文件链接时的钩子，返回字段为 file， 可以通过 file.response 拿到服务端返回数据',
    type: 'Function',
    default: ''
  },
  {
    name: 'onFormatError',
    desc: '文件格式验证失败时的钩子，返回字段为 file, fileList',
    type: 'Function',
    default: ''
  },
  {
    name: 'onExceededSize',
    desc: '文件超出指定大小限制时的钩子，返回字段为 file, fileList',
    type: 'Function',
    default: ''
  }
]
