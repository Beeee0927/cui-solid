        ...
        <Space dir="v" size={32}>
          ...
          <Space id="form_dynamic_rule3" dir="v">
            <Card bordered>
              ...
              >
                {showAlerts() ? (
                  <FormItem name="alerts" label="告警：">
                    <Input />
                  </FormItem>
                ) : null}
              </Form>
              <Button
                icon={showAlerts() ? <FeatherMinus /> : <FeatherPlus />}
                onClick={() => {
                  ...
                  {(item, index: Accessor<number>) => {
                    return (
                      <FormItem
                        name={`alerts.${index()}`}
                        label="告警："
                        rules={[{ required: true, message: '告警不能为空' }]}
                      >
                        <Input />
                      </FormItem>
                    )
                  ...
                  {(item, index: Accessor<number>) => {
                    return (
                      <Space>
                        ...
                        <FormItem
                          name={`alerts.${index()}.rule`}
                          label="告警规则："
                          rules={[
                            { required: true, message: '告警规则不能为空' }
                          ]}
                        >
                          <Input />
                        </FormItem>
          ...
          <Space id="form_async_validate" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">async-validator</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                Form 组件支持{' '}
                <Text type="primary">
                ...
                方式实现的数据验证，给在 useForm 中设置的 validation
                各属性校验规则为数组格式。
              </Paragraph>
                ...
                <Row>
                  <Col grid={0.33}>
                    <FormItem
                      ...
                      name="check"
                      rules={[
                        { required: true, type: 'boolean', message: '请选择' }
                      ]}
                    >
                  ...
                  <Col grid={0.33}>
                    <FormItem
                      ...
                      name="fruit"
                      rules={[
                        { required: true, type: 'array', message: '请选择' }
                      ]}
                    >
                      <Space dir="h" align="baseline">
                        <CheckboxGroup
                ...
                <Row>
                  ...
                  <Col grid={0.33}>
                    <FormItem
                      ...
                      name="age"
                      rules={[
                        { max: 10, type: 'integer', message: '不能大于10' }
                      ]}
                    >
                      <Space dir="h" align="center">
                        <Spinner />
