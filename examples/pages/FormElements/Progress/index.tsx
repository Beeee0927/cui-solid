  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Progress 进度条</Title>
            ...
            <Card bordered>
              <Space dir="h" inline>
                <Progress
                  type="circle"
                  value={100}
                  infoRender={(sta: string, value: number) => {
                    if (value === 100) {
                      return '完成'
                    } else {
                      return '进行中'
