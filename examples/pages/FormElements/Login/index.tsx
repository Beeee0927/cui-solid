  ...
  return (
    <>
      <div class="sys-ctx-main-left">
        <Space dir="v" size={32}>
          <Title heading={2}>Login 登录</Title>
          ...
          <Space id="login_img_captcha" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">图形验证码</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                Captcha
                默认为获取验证码按钮，指定action属性后为图形验证码，点击可刷新验证码。
              </Paragraph>
          ...
          <Space id="login_custom_rule" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">自定义校验及组合</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                各组件都有默认的校验规则
                rules，不过也可以根据场景自定义，比如实现一个密码二次确认的校验。
