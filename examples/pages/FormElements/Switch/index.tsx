  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Switch 开关</Title>
          <Space id="switch_base" dir="v">
            <Card bordered>
              ...
              <Switch round={false} />
              <Switch
                icon={<FeatherSettings color="var(--cui-primary-color)" />}
              />
              <Switch
                size="large"
                icon={[
          ...
          <Space id="switch_before" dir="v">
            <Card bordered>
              <Space dir="h">
                <Switch
                  onBeforeChange={(checked: boolean) => {
              ...
              <Divider align="left">
                <Text type="primary">阻止切换</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                onBeforeChange 可以在切换之前判断是否需要切换， 返回 false
                阻止切换
              </Paragraph>
