  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Checkbox 多选框</Title>
          ...
          <Space id="checkbox_group_disabled" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">组合禁用</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                使用 CheckboxGroup 的 disabled 属性可禁用整个组合， 数据项中的
                disabled 属性可禁用组合项
              </Paragraph>
          ...
          <Space id="checkbox_field" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">自定义字段</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                使用 <Text code>data</Text> 传入数据时， 可通过{' '}
                <Text code>textField</Text> <Text code>valueField</Text>{' '}
                选择显示的字段和值字段
              </Paragraph>
