...
export default function DrawerPage() {
  ...
  const [align, setAlign] = createSignal<'right' | 'left' | 'top' | 'bottom'>(
    'right'
  )
  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Drawer 抽屉</Title>
          ...
          <Space id="drawer_align" dir="v">
            <Card bordered>
              ...
              <Paragraph type="secondary" spacing="extended">
                <Text code>align</Text> 属性支持 <Text code>left</Text>{' '}
                <Text code>right</Text> <Text code>top</Text>{' '}
                <Text code>bottom</Text>
