  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>PageFooter 页脚</Title>
            ...
            <Card bordered>
              <PageFooter>
                <Floor dividerBottom padding="20px 0">
                  <Space
                    align="center"
                    style={{ 'justify-content': 'space-around', flex: 1 }}
                  >
                ...
                <Floor padding="20px 0" dividerBottom>
                  <FooterNavigations>
                    ...
                    <FooterNavigation head="其他">
                      <FooterNavigation.Link link="#" icon={<FeatherLink />}>
                        开发者中心
                      </FooterNavigation.Link>
                      <FooterNavigation.Link link="#" icon={<FeatherLink />}>
                        开发者课堂
                    ...
                    <FooterNavigation head="关注我们">
                      <QRCode
                        value="https://gitee.com/cqb325/cui-solid"
                        icon={img}
                      />
                    </FooterNavigation>
                  </FooterNavigations>
