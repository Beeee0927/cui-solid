  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>QRCode 二维码</Title>
          ...
          <Space id="qrcode_level" dir="v">
            <Card bordered>
              <Space dir="h">
                <QRCode
                  value="https://gitee.com/cqb325/cui-solid/blob/master/src/assets/images/logo.svg"
                  level="L"
                />
                <QRCode
                  value="https://gitee.com/cqb325/cui-solid/blob/master/src/assets/images/logo.svg"
