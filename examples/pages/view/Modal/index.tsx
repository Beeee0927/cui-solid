  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Modal 模态对话框</Title>
          ...
          <Space id="modal_style" dir="v">
            <Card bordered>
              ...
              <Modal
                title="提示"
                visible={[visible3, setVisible3]}
                defaultPosition={{ top: '200px' }}
              >
                <div>modal 内容</div>
                <div>modal 内容</div>
                <div>modal 内容</div>
          ...
          <Space id="modal_reset" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">重新打开重置位置</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                设置<Text code>resetPostion</Text> 属性，拖拽后
                重新打开会定位到初始化位置
              </Paragraph>
          ...
          <Space id="modal_maskclose" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">禁用遮罩关闭</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                设置<Text code>maskClosable</Text>{' '}
                属性为false，禁用遮罩点击关闭对话框功能
              </Paragraph>
          ...
          <Space id="modal_instance" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">单实例使用</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                使用modal的
                方法弹出对话框，onOk回调可以返回一个true/false,来控制modal的关闭，返回true立即关闭，
                返回false不关闭会将loading重置，不返回或undefined，则按照默认方式处理
              </Paragraph>
