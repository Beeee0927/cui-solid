  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Image 图片</Title>
          <Space id="image_base" dir="v">
            <Card bordered>
              ...
              <Paragraph type="secondary" spacing="extended">
                可通过 fit 来设置图片在容器的样式，同原生{' '}
                <Text link="https://developer.mozilla.org/en-US/docs/Web/CSS/object-fit">
                  object-fit
                </Text>
                。
              </Paragraph>
          ...
          <Space id="image_placeholder" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">占位</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                通过<Text code>placeholder</Text>
                属性可以自定义占位样式，可通过console的Network修改网络速率进行测试
              </Paragraph>
          ...
          <Space id="image_lazy" dir="v">
            <Card bordered>
                    ...
                    {(url: string) => {
                      return (
                        <Image
                          src={url}
                          lazy
                          scrollContainer=".demo-image-lazy-vertical"
                        />
                      )
                    }}
                  </For>
              ...
              <Divider align="left">
                <Text type="primary">懒加载</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                设置属性 <Text code>lazy</Text>{' '}
                可以开启图片懒加载功能，当图片滚动到可视范围内才会加载。
              </Paragraph>
          ...
          <Space id="image_preview" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">预览</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                设置属性 <Text code>preview</Text>{' '}
                可以开启图片预览模式，通过属性 <Text code>previewList</Text>{' '}
                来设置图片列表，<Text code>previewIndex</Text>{' '}
                属性设置打开预览时显示图片的索引。
                <br />
                预览时，可以使用 <kbd>←</kbd>、<kbd>→</kbd> 切换图片，
                <kbd>↑</kbd>、<kbd>↓</kbd> 缩放图片，<kbd>Space</kbd> 显示 1:1
                图片，<kbd>ESC</kbd> 退出预览。
              </Paragraph>
          ...
          <Space id="image_image_preview" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">单独使用图片预览</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
