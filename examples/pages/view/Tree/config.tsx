...
export const propsData = [
  ...
  {
    name: 'checkRelation',
    desc: '选择框的级联关系 related|unRelated ',
    type: 'string',
    default: 'related'
  },
  ...
  {
    name: 'beforeDropMethod',
    desc: '拖拽释放前的逻辑判断返回true才允许释放',
    type: 'Function',
    default: ''
  },
  {
    name: 'beforeExpand',
    desc: '展开节点前的方法，返回true才能展开',
    type: 'Function',
    default: ''
  },
  {
    name: 'selected',
    desc: '可控选中节点id',
    type: 'NodeKeyType | Signal<NodeKeyType>',
    default: ''
  },
  {
    name: 'value',
  ...
  {
    name: 'mode',
    desc: '树数据选择模式，FULL、HALF、CHILD、SHALLOW',
    type: 'String',
    default: ''
  },
  {
...
export const eventsData = [
  ...
  { name: 'onContextMenu', desc: '右键菜单事件', params: 'node:TreeNode' },
  {
    name: 'onNodeCheck',
    desc: '节点勾选事件',
    params: 'node:TreeNode, checked: boolean'
  },
  {
    name: 'onNodeDrop',
    desc: '节点拖拽释放事件',
    params:
      'e: any, node: TreeNode, dragNode: TreeNode, hoverPart: dragHoverPartEnum'
  },
  {
    name: 'onNodeDragStart',
    desc: '节点拖拽开始事件',
    params: 'e: any, node: TreeNode'
  },
  {
    name: 'onNodeDragEnter',
    desc: '节点拖入事件',
    params: 'e: any, node: TreeNode, hoverPart: dragHoverPartEnum'
  },
  {
    name: 'onNodeDragOver',
    desc: '节点拖拽Over事件',
