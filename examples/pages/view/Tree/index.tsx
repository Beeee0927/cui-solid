...
export default function TreePage() {
  ...
  const [data11, setData11]: any = createSignal([
    { id: '1', title: '动态数据' }
  ])
  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Tree 树状控件</Title>
          ...
          <Space id="tree_multi_unrelate" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">非级联多选</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                <Text code>checkRelation</Text>{' '}
                参数可以设置多选场景下的级联情况，<Text code>unRelated</Text>
                非级联 <Text code>related</Text> 级联
              </Paragraph>
          ...
          <Space id="tree_loadData" dir="v">
            <Card bordered>
              ...
              />
              <Divider align="left">
                <Text type="primary">动态加载</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                数据项存在<Text code>loading</Text> 参数， 可通过{' '}
                <Text code>loadData</Text> 方法动态加载子节点
              </Paragraph>
          ...
          <Space id="tree_customArrow" dir="v">
            <Card bordered>
              <Tree
                ...
                checkable
                directory
                arrowIcon={() => <img src={arrow} />}
              />
              <Divider align="left">
                <Text type="primary">自定义箭头</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                自定义箭头
              </Paragraph>
          ...
          <Space id="tree_mod" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">模式</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                mode支持四种TreeCheckMod.FULL, TreeCheckMod.HALF,
                TreeCheckMod.CHILD, TreeCheckMod.SHALLOW, 不同模式产生的值不同，
                默认是HALF
              </Paragraph>
              <DemoCode data={codes['tree_contextmenu']} />
            </Card>
          ...
          <Space id="tree_append" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">append</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                append追加子节点，prepend 添加前缀子节点, insertBefore:
                在某节点前插入兄弟节点, insertAfter: 在某节点后插入兄弟节点
              </Paragraph>
              <DemoCode data={codes['tree_contextmenu']} />
            </Card>
          </Space>
          ...
          <Space id="tree_dragable" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">拖拽</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                draggable支持节点拖拽， 可通过 beforeDropMethod
                来判断是否可进行拖放节点，支持异步判断
              </Paragraph>
              <DemoCode data={codes['tree_contextmenu']} />
            </Card>
          ...
          <Space id="tree_scroll" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">Scroll</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                Scroll 支持滚动到某个节点，支持指定滚动到容器的 Top
                、Center、Bottom，需要传入节点的 key。
              </Paragraph>
              <DemoCode data={codes['tree_contextmenu']} />
            </Card>
          </Space>
            ...
            <Card bordered>
              ...
              <Space dir="v">
                ...
                <Space>
                  ...
                  >
                    getCheckedKeys(SHALLOW)
                  </Button>
                </Space>
              </Space>
              <Divider align="left">
                <Text type="primary">接口</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                支持通过checkNode 进行勾选和取消勾选
                <br />
                通过checkAll和unCheckAll 进行全选和全不选
                <br />
                可通过getChecked和getCheckedKeys
                获取选中的数据或key，支持四种模式
              </Paragraph>
