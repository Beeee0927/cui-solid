  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Notice 通知</Title>
          ...
          <Space id="notice_type" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">不同类型的通知</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                notice 不同的通知 可以使用不通的方法触发，包含{' '}
                <Text code>info</Text>、<Text code>success</Text>
                <Text code>warning</Text>、<Text code>error</Text>、
                <Text code>help</Text>
              </Paragraph>
          ...
          <Space id="notice_dock" dir="v">
            <Card bordered>
              ...
              <Paragraph type="secondary" spacing="extended">
                dock 属性定义通知出现的位置， 支持{' '}
                <Text code>topRight(默认)</Text> <Text code>bottomRight</Text>
