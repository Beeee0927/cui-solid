  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Banner 通知横幅</Title>
          <Space id="banner_base" dir="v">
            <Card bordered>
              <Space dir="v">
                <Banner type="info">
                  <div>
                    备注： 如果你还没有安装上述软件，有关安装 NPM 和 Node.js
                    的方法在这里。
                  </div>
                </Banner>
                <Banner type="warning">
              ...
              <Paragraph type="secondary" spacing="extended">
                基本用法,支持4种类型：info、warning、error、success。默认为
                info。
              </Paragraph>
          ...
          <Space id="banner_fullmode" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">非全屏模式</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                可以设置 fullMode={false} 使用非全屏模式的 banner 样式。 通过
                bordered 属性可以设置边框。
              </Paragraph>
