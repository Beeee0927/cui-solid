  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Draggable 拖拽</Title>
            ...
            <Card bordered>
              <div style={{ height: '200px', position: 'relative' }}>
                <Draggable>
                  ...
                  >
                    <div style={{ height: '30px' }} class="drag-handler">
                      Handler
                    </div>
                  </div>
                </Draggable>
          ...
          <Space id="draggable_axis" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">方向</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                axis默认为Both、可以限制在某X、Y轴上。
                <br />
            ...
            <Card bordered>
              ...
              >
                <Draggable axis="both" bounds="parent" handle=".handler">
                  ...
                  >
                    <div class="handler" style={{ cursor: 'move' }}>
                      Handler
                    </div>
                  </div>
                </Draggable>
