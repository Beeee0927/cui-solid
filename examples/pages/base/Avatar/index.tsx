  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Avatar 头像</Title>
          ...
          <Space id="avatar_hover" dir="v">
            <Card bordered>
              <Space dir="h" align="center">
                <Avatar
                  size={48}
                  icon={<FeatherSettings size={24} />}
                  style={{
                    'background-color': 'rgb(242 168 113)',
                    color: 'rgb(245, 106, 0)'
                  }}
                  hoverMask={
                    <div style={style}>
