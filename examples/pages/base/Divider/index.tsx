  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Divider 分割线</Title>
          ...
          <Space id="divider_align" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">文字位置</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                使用 <Text code>align</Text> 设置为文字的位置，支持left和right
                默认居中
              </Paragraph>
          ...
          <Space id="divider_margin" dir="v">
            <Card bordered>
              <section>
                ...
                <Divider align="right" margin="20px 0 10px 0">
                  分割线
                </Divider>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
              ...
              <section>
                ...
                >
                  {(color) => {
                    return (
                      <>
                        <Divider align="left" theme={color}>
                          {color}
                        </Divider>
                      </>
                    )
