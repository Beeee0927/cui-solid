  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Typography 排版</Title>
          <Space id="typography_title" dir="v">
            <Card bordered>
              ...
              <Title style={{ margin: '8px 0' }} inline>
                h1. Inline Typography Title
              </Title>
              <div>
                <Title
                  heading={3}
              ...
              <div>
                <Title
                  ...
                  inline
                  prefix="bar"
                  prefixColor={['-45deg', '#ff0000', '#2080f0']}
                  gradient={['-45deg', '#ff0000', '#2080f0']}
                >
                  中文Typography Title With Bar
                </Title>
          ...
          <Space id="typography_copy" dir="v">
            <Card bordered>
              <Space dir="v">
                <Paragraph copyable>CMUI Web 组件库。</Paragraph>
                <Paragraph copyable copyText="自定义内容">
                  自定义拷贝内容。
                </Paragraph>
              </Space>
              <Divider align="left">
                <Text type="primary">可拷贝</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                提供复制文本的能力
              </Paragraph>
          ...
          <Space id="typography_spacing" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">行间距</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                可通过设置 <Text mark>spacing</Text>{' '}
                设置段落行距,不设置为默认行距 extended为宽松行距
              </Paragraph>
