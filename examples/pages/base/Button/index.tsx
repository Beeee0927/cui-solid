...
import {
  ...
  F7Search,
  F7Trash
} from 'cui-solid-icons/f7'
import { RadioGroup, Switch } from '@/components'
import {
  FeatherChevronRight,
  FeatherPlus,
  FeatherSearch
} from 'cui-solid-icons/feather'
useDirective(hljs)
        ...
        <Space dir="v" size={32}>
          ...
          <div id="button_type">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">按钮类型</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                通过设置 type 为
                primary、secondary、tertiary、success、warning、error、danger、default
                创建不同样式的按钮，不设置为默认样式。
              </Paragraph>
            </Card>
          </div>
          ...
          <div id="button_theme">
            <Card bordered>
              <Space dir="v" size={24} inline align="baseline">
                ...
                />
                <Space dir="h">
                  <Button theme={theme()} type="primary">
                    Primary
                  </Button>
                  <Button theme={theme()} type="secondary">
                    Secondary
                  </Button>
                  <Button theme={theme()} type="tertiary">
                    Tertiary
                  </Button>
                  <Button theme={theme()} type="success">
                    Success
                  </Button>
                </Space>
                <Space dir="h">
                  <Button theme={theme()} type="error">
                    Error
                  </Button>
                  <Button theme={theme()} type="danger">
                    Danger
                  </Button>
                  <Button theme={theme()} type="warning">
                    Warning
                  </Button>
                  <Button theme={theme()} type="default">
                    Default
                  </Button>
                </Space>
              </Space>
              <Divider align="left">
                <Text type="primary">样式</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
          ...
          <div id="button_disabled">
            <Card bordered>
              <Space dir="v" size={24} inline align="baseline">
                ...
                />
                <Space>
                  禁用: <Switch checked={[disabled, setDisabled]} />
                </Space>
                <Space dir="h">
                  <Button theme={theme()} disabled={disabled()} type="primary">
                    Primary
                  </Button>
                  <Button
                    theme={theme()}
                  ...
                  <Button theme={theme()} disabled={disabled()} type="tertiary">
                    Tertiary
                  </Button>
                  <Button theme={theme()} disabled={disabled()} type="success">
                    Success
                  </Button>
                </Space>
                <Space dir="h">
                  <Button theme={theme()} disabled={disabled()} type="error">
                    Error
                  </Button>
                  <Button theme={theme()} disabled={disabled()} type="danger">
                    Danger
                  </Button>
                  <Button theme={theme()} disabled={disabled()} type="warning">
                    Warning
                  </Button>
                  <Button theme={theme()} disabled={disabled()} type="default">
                    Default
                  </Button>
                </Space>
              </Space>
              <Divider align="left">
                <Text type="primary">禁用按钮</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
            ...
            <Card bordered>
              <Space dir="v">
                <Space dir="h" align="center">
                  ...
                  <Button size="small" icon={<FeatherChevronRight />}>
                    To Right
                  </Button>
                </Space>
                <Space dir="h">
          ...
          <div id="button_shaps">
            <Card bordered>
              <Space dir="h" align="center">
                ...
                <Button type="primary" shape="round" icon={<F7Search />}>
                  圆角按钮
                </Button>
                <Button type="primary" shape="circle" icon={<F7Search />} />
                <Button type="success" size="large" shape="round">
                  Success
                </Button>
              </Space>
              <Divider align="left">
                <Text type="primary">形状</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
            ...
            <Card bordered>
              <Space dir="v">
                ...
                <Space dir="h" align="center">
                  ...
                  <Button type="primary" icon={<F7Search />} iconAlign="right">
                    Search
                  </Button>
                </Space>
              </Space>
              <Divider align="left">
                <Text type="primary">图标按钮</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                通过设置<Text code>icon</Text>属性在Button内嵌入一个Icon
              </Paragraph>
              <Paragraph type="secondary" spacing="extended">
                使用Button的<Text code>icon</Text>
                属性，图标位置将在最左边，通过设置 <Text code>iconAlign</Text>{' '}
                将按钮放置在后面。
              </Paragraph>
              <Paragraph type="secondary" spacing="extended">
          ...
          <div id="button_loading">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">加载中状态</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                通过添加<Text code>loading</Text>
                属性可以让按钮处于加载中状态,可点击动态设置
              </Paragraph>
          ...
          <div id="button_group">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">按钮组</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                将多个Button放入ButtonGroup内，可实现按钮组合的效果。
              </Paragraph>
              <Paragraph type="secondary" spacing="extended">
                通过设置ButtonGroup的属性<Text code>size</Text>
                为large和small，可将按钮组尺寸设置为大和小，不设置
                <Text code>size</Text>，则为默认（中）尺寸。
              </Paragraph>
              <Paragraph type="secondary" spacing="extended">
