        ...
        <Space dir="v" size={32}>
          ...
          <Space id="tag_type" dir="v">
            <Card bordered>
              <Space dir="h">
                ...
                <Tag theme="primary" circle>
                  Circle
                </Tag>
                <Tag theme="primary" border avatar={<Avatar>U</Avatar>}>
                  Avatar
                </Tag>
              </Space>
              <Divider align="left">
                <Text type="primary">标签类型</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                value属性可以设置具备显示值的标签
                <br />
          ...
          <Space id="tag_theme" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">内置样式</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                通过设置theme选取内置样式 <Text code>primary</Text>{' '}
                <Text code>danger</Text> <Text code>warning</Text>
                <Text code>success</Text> <Text code>info</Text>{' '}
                <Text code>magenta</Text>
                <Text code>red</Text> <Text code>volcano</Text>{' '}
                <Text code>orange</Text>
                <Text code>gold</Text> <Text code>yellow</Text>{' '}
                <Text code>lime</Text>
                <Text code>green</Text> <Text code>cyan</Text>{' '}
                <Text code>blue</Text>
          ...
          <Space id="tag_closeable" dir="v">
            <Card bordered>
              <Space dir="h">
                ...
                <Tag value={10} closable>
                  Value
                </Tag>
                <Tag theme="primary" circle closable>
                  Circle
                </Tag>
                <Tag theme="primary" closable avatar={<Avatar>U</Avatar>}>
                  Avatar
                </Tag>
              </Space>
              <Divider align="left">
                <Text type="primary">可关闭</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                设置closable属性可以关闭标签
              </Paragraph>
          ...
          <Space id="tag_size" dir="v">
            <Card bordered>
              <Space dir="h">
                ...
                <Tag size="large" avatar={<Avatar>U</Avatar>}>
                  标签一
                </Tag>
                <Tag size="large" value={10}>
                  标签一
                </Tag>
                <Tag size="xlarge">标签一</Tag>
                <Tag size="xlarge" avatar={<Avatar>U</Avatar>}>
                  标签一
                </Tag>
                <Tag size="xlarge" value={10}>
                  标签一
                </Tag>
                <Tag theme="primary">标签二</Tag>
              </Space>
              <Divider align="left">
                <Text type="primary">尺寸</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                size属性支持large
              </Paragraph>
          ...
          <Space id="tag_control" dir="v">
            <Card bordered>
              <Space dir="h">
                <Tag theme="primary" closable visible={[visible, setVisible]}>
                  标签一
                </Tag>
                <Button
                  size="small"
