  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Skeleton 骨架屏</Title>
            ...
            <Card bordered>
              ...
              <div>
                <Skeleton placeholder={<Skeleton.Avatar />} loading={loading()}>
                  <Avatar style={{ color: 'blue', 'margin-bottom': '10px' }}>
                    U
                  </Avatar>
                </Skeleton>
                <br />
                ...
                <Skeleton
                  style={{ width: '80px' }}
                  placeholder={
                    <Skeleton.Title style={{ 'margin-bottom': '10px' }} />
                  }
                  loading={loading()}
                >
