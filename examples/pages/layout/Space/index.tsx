  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Space 间隔</Title>
          ...
          <Space id="space_vertical" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">垂直间距</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                设置属性 <Text code>dir</Text> 为 <Text code>v</Text>{' '}
                可以使相邻组件垂直排列。
              </Paragraph>
