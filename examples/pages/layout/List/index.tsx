          ...
          <Space id="list_base" dir="v">
            <Card bordered>
              ...
              <Paragraph type="secondary" spacing="extended">
                默认列表, <Text code>head</Text> <Text code>foot</Text> 使用{' '}
                <Text code>Slot</Text> 名称为 <Text code>head</Text>、
                <Text code>foot</Text>
              </Paragraph>
            ...
            <Card bordered>
              ...
              >
                <For each={data}>
                  {(item) => {
                    return (
                      <List.Item id={item.id} desc={item.desc} data={item} />
                    )
                  }}
                </For>
              </List>
