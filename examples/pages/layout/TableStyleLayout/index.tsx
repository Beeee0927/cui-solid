...
import {
  TableStyleLayout,
  TableStyleLayoutRow,
  TableStyleLayoutLabel,
  TableStyleLayoutValue,
  TableStyleLayoutCol
} from '@/components/TableStyleLayout'
  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>TableStyleLayout 类表格布局</Title>
          <Space id="split_base" dir="v">
            <Card bordered>
              <TableStyleLayout labelWidth={100}>
                ...
                <TableStyleLayoutRow>
                  <TableStyleLayoutLabel verticalAlign="start">
                    字段信息
                  </TableStyleLayoutLabel>
                  <TableStyleLayoutValue>
          ...
          <Space id="split_form" dir="v">
            <Card bordered>
              <Form form={form} errorTransfer errorAlign="bottomLeft">
                <TableStyleLayout labelWidth={100}>
                  <TableStyleLayoutRow>
                    <TableStyleLayoutLabel required>
                      用户名
                    </TableStyleLayoutLabel>
                    <TableStyleLayoutValue>
