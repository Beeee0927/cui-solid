  ...
  return (
    <View>
      <div class="sys-ctx-main-left">
        <Space dir="v" size={32}>
          <Title heading={2}>View 视图</Title>
          <Paragraph type="secondary" spacing="extended">
            包含 <Text code>View</Text> <Text code>VView</Text>{' '}
            <Text code>HView</Text>三种视图
          </Paragraph>
        </Space>
      </div>
      ...
      <VView class="components-layout-demo" size="450px">
        ...
        <HView style={centerStyle}>
          <View size="200px" style={centerStyle} class="layout-demo-sider">
            Sider
          </View>
          <View style={centerStyle}>MAIN</View>
        </HView>
      ...
      <HView class="components-layout-demo" size="450px">
        <View size="150px" style={centerStyle} class="layout-demo-sider">
          Sider
        </View>
