  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Badge 徽标</Title>
          ...
          <Space id="badge_overcount" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">封顶数字</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                通过设置 <Text code>overflowCount</Text>{' '}
          ...
          <Space id="badge_alone" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">独立使用及自定义样式</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                独立使用及自定义样式
              </Paragraph>
          ...
          <Space id="badge_color" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">多彩徽标</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                属性 <Text code>color</Text>{' '}
          ...
          <Space dir="v">
            <Card bordered>
              ...
              <Space size={24}>
                <Space dir="v" inline>
                  <For
                    each={['primary', 'success', 'warning', 'info', 'error']}
                  >
                    {(color) => (
                      <BadgeRibbon text="Ribbon" color={color}>
                        <Card
                          style={{ width: '300px' }}
                          title="Card Title"
                          bordered
                ...
                <Space dir="v" inline>
                  ...
                  >
                    {(color) => (
                      <BadgeRibbon text={color} color={color}>
                        <Card
                          style={{ width: '300px' }}
                          title="Card Title"
                          bordered
