...
export const propsData = [
  ...
  {
    name: 'status',
    desc: '状态徽标success|error|processing|warning|default',
    type: 'string',
    default: ''
  },
  {
    name: 'color',
    desc: '圆点徽标的颜色 blue|green|red|yellow|pink|magenta|volcano|orange|gold|lime|cyan|geekblue|purple，自定义颜色',
    type: 'string',
    default: ''
  },
  {
    name: 'type',
    desc: '不通类型显示不同颜色 primary|success|normal|info|error|warning',
    type: 'string',
    default: ''
  }
]
