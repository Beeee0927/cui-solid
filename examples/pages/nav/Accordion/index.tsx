  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Accordion 手风琴面板</Title>
            ...
            <Card bordered>
              <HView class="components-layout-demo" size="450px">
                <View
                  ...
                  class="layout-demo-sider"
                >
                  <Accordion
                    onSelect={(name: string, open: boolean, v: any) => {
            ...
            <Card bordered>
              <VView size="300px">
                <HView class="components-layout-demo" size="450px">
                  <View
                    size="250px"
                    style={{ 'text-align': 'initial', overflow: 'auto' }}
                    class="layout-demo-sider"
                  >
                    <Accordion
              ...
              <Paragraph type="secondary" spacing="extended">
                设置 <Text code>multi</Text> 属性可以展开多个面板
                <br />
