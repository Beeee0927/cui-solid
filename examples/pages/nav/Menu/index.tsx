  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Menu 导航菜单</Title>
          <Space id="menu_base" dir="v">
            <Card bordered>
              <Menu dir="h">
                ...
                <MenuItem name="2" icon={<F7PersonFill />}>
                  用户管理
                </MenuItem>
                <MenuItem name="31" icon={<FeatherList />}>
                  菜单管理
                </MenuItem>
                <MenuItem name="33" icon={<FeatherTool />}>
                  权限管理
                </MenuItem>
              ...
              <Divider align="left">
                <Text type="primary">横向菜单</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                菜单项包含 <Text code>MenuItem</Text>、<Text code>SubMenu</Text>
                、<Text code>MenuGroup</Text>
                <br />
                横向菜单需指定 <Text code>dir</Text> 为 <Text code>h</Text>
                <br />
                横向菜单的子菜单触发条件为hover
              </Paragraph>
          ...
          <Space id="menu_vertical" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">侧边菜单</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                侧边菜单需指定 <Text code>dir</Text> 为 <Text code>v</Text>
                <br />
                默认选中的菜单可指定 <Text code>activeName</Text>
                ，如果选中的菜单项为子菜单，默认展开父菜单项,
          ...
          <Space id="menu_accordion" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">手风琴方式</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                侧边菜单指定 <Text code>accordion</Text>{' '}
                属性，可以让菜单的打开方式支持手风琴方式
                <br />
              </Paragraph>
          ...
          <Space id="menu_theme" dir="v">
            <Card bordered>
              <Space dir="v">
                ...
                <div
                  style={{ width: '220px', 'border-right': '1px solid #ccc' }}
                >
              ...
              <Divider align="left">
                <Text type="primary">菜单主题</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                菜单主题通过 <Text code>theme</Text> 属性设置 支持{' '}
                <Text code>light</Text>、<Text code>dark</Text>
              </Paragraph>
          ...
          <Space id="menu_min" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">最小化菜单</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                菜单最小化的顶级菜单需添加图标，最小化后只显示图标，最小化的{' '}
                <Text code>min</Text> 参数为可控绑定属性
              </Paragraph>
