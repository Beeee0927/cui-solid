  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Dropdown 下拉菜单</Title>
          <Space id="dropdown_base" dir="v">
            <Card bordered>
              <Dropdown
                trigger="click"
                align="bottomLeft"
                gradient={['45deg', '#9B59B6', '#3498DB']}
                color="#ffffff"
                menu={
                  <DropdownMenu>
                    <DropdownItem name="edit" icon={<F7SquarePencil />} arrow>
                      Edit
                      <DropdownMenu>
                    ...
                    <DropdownItem disabled icon={<F7Heart />}>
                      Save to Wishlist
                    </DropdownItem>
                    <DropdownItem divided arrow icon={<BiShareFill />}>
                      Share
                      <DropdownMenu>
                    ...
                    <DropdownItem divided icon={<F7Photo />}>
                      View image
                    </DropdownItem>
          ...
          <Space id="dropdown_trigger" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">触发条件</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                通过设置属性 <Text code>trigger</Text>{' '}
                可以更改触发方式，可选项为 <Text code>click</Text> 、{' '}
                <Text code>hover(默认)</Text>、 <Text code>contextMenu</Text> 或{' '}
                <Text code>custom(自定义)</Text>。<br />
                触发方式设置为 <Text code>
                  custom
                </Text> 自定义时，需手动设置 <Text code>visible</Text>{' '}
                属性来控制下拉框的显示。
              </Paragraph>
          ...
          <Space id="dropdown_transfer" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">Transfer</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                设置 <Text code>transfer</Text>{' '}
                属性可以让下拉菜单渲染到Body节点下
              </Paragraph>
          ...
          <Space id="dropdown_align" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">位置</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                align属性支持12个方位， 最常用的是bottom/bottomLeft/bottomRight,
                默认为bottom
              </Paragraph>
          ...
          <Space id="dropdown_arrow" dir="v">
            <Card bordered>
              <Space dir="v">
                  ...
                  >
                    {(align) => (
                      <Dropdown
                        ...
                        arrow
                        trigger="click"
                        align={align as DropdownProps['align']}
                        menu={menu}
                      >
                        <Button>{align}</Button>
                      </Dropdown>
                ...
                <Space>
                  Offset:{' '}
                  <Slider max={24} min={0} value={[offset, setOffset]} />
                </Space>
              </Space>
              <Divider align="left">
                <Text type="primary">Arrow</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                Arrow
              </Paragraph>
            ...
            <Card bordered>
              <Space>
                <Dropdown
                  ...
                  menu={
                    <DropdownMenu>
                      <DropdownItem name="0" icon={<F7CubeBox />}>
                        Menu Item 1
                      </DropdownItem>
                      <DropdownItem name="1" icon={<F7Gear />} theme="primary">
                        驴打滚
                      </DropdownItem>
                      <DropdownItem
                        name="2"
                        icon={<F7ArrowshapeTurnUpRight />}
                        theme="secondary"
                      >
                        炸酱面
                      </DropdownItem>
                      ...
                      <DropdownItem name="5" icon={<F7Star />} theme="warning">
                        挂炉烤鸭
                      </DropdownItem>
                      <DropdownItem
                        name="6"
                        icon={<F7TrayArrowDown />}
                        theme="info"
                      >
                        焖炉烤鸭
                      </DropdownItem>
