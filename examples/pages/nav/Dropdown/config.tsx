...
export const propsData = [
  ...
  {
    name: 'trigger',
    desc: '触发方式 hover|click|contextMenu|custom',
    type: 'string',
    default: 'hover'
  },
  ...
  {
    name: 'align',
    desc: '触发方式 bottom|bottomLeft|bottomRight|right|left|rightTop|leftTop',
    type: 'string',
    default: 'bottom'
  },
  ...
  {
    name: 'transfer',
    desc: '是否将弹层放置于 body 内，在overflow 为 hidden的容器内效果更友好',
    type: 'boolean',
    default: ''
  },
  {
    name: 'fixWidth',
    desc: '是否在使用transfer时打开弹框后弹框固定宽度至出发元素宽度，在select中使用',
    type: 'boolean',
    default: ''
  },
  {
