  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Steps 步骤</Title>
              ...
              <Space dir="v">
                <Steps current={current()}>
                  ...
                  <Steps.Step
                    title="等待"
                    status="wait"
                    icon={<IoniconsLockClosed size={26} />}
                  />
                </Steps>
              </Space>
              <Divider align="left">
                <Text type="primary">状态和图标</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                status 支持 finished process error warning wait
                其中finished状态、warning和error状态有默认图标
              </Paragraph>
