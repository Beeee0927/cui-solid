  ...
  return (
    <>
      <div class="sys-ctx-main-left" use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Pagination 分页</Title>
          ...
          <Space id="pagination_small" dir="v">
            <Card bordered>
              ...
              <Paragraph type="secondary" spacing="extended">
                小尺寸分页组件， 设置 <Text code>size</Text> 为{' '}
                <Text code>small</Text>
              </Paragraph>
