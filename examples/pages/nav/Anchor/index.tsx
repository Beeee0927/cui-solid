  ...
  return (
    <>
      <div class="sys-ctx-main-left">
        <Space dir="v" size={32}>
          <Title heading={2}>Anchor 锚点</Title>
          <Space id="pagination_base" dir="v">
            <HView>
              <View
                class="anchor-scroll-container"
                style={{
                  height: '200px',
                  overflow: 'auto',
          ...
          <Space id="pagination_towRow" dir="v">
            <HView>
              <View
                class="anchor-scroll-container2"
                style={{
                  height: '200px',
                  overflow: 'auto',
                  border: '1px solid #ccc'
                ...
                <Row gutter={24}>
                  <Col xs={1} lg={1} xl={0.5} style={{ position: 'static' }}>
                    <div
                      id="basic_usage2"
                      classList={{
                        'demo-anchor-active': currentAnchor() === 'basic_usage2'
                      }}
                    >
                    ...
                    <div
                      id="API2"
                      classList={{
                        'demo-anchor-active': currentAnchor() === 'API2'
                      }}
                    >
                  ...
                  <Col xs={1} lg={1} xl={0.5} style={{ position: 'static' }}>
                    <div
                      ...
                      classList={{
                        'demo-anchor-active':
                          currentAnchor() === 'static_position2'
                      }}
                    >
                    ...
                    <div
                      id="AnchorLink_props2"
                      classList={{
                        'demo-anchor-active':
                          currentAnchor() === 'AnchorLink_props2'
                      }}
                    >
              ...
              <div style={{ width: '200px', 'padding-left': '32px' }}>
                <Anchor
                  mode="history"
                  container={'.anchor-scroll-container2'}
                  onChange={(key) => {
