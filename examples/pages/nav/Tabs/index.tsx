  ...
  return (
    <>
      <div class="sys-ctx-main-left" style={{ width: 0 }} use:hljs={''}>
        <Space dir="v" size={32}>
          <Title heading={2}>Tabs 标签页</Title>
            ...
            <Card bordered>
              <Space dir="v">
                <Tabs activeName="tab1" duration={200} keepHeight>
                  ...
                  <TabPane title="标签二" name="tab2">
                    标签二的内容
                  </TabPane>
                  <TabPane title="标签三" name="tab3">
                    标签三的内容
                  </TabPane>
                </Tabs>
          ...
          <Space dir="v">
            <Card bordered>
              ...
              <Tabs activeName="tab1" align="left">
                <TabPane title="标签一" name="tab1" closeable>
                  标签一的内容
                </TabPane>
                <TabPane title="标签二" name="tab2">
                  标签二的内容
          ...
          <Space id="tabs_disabled" dir="v">
            <Card bordered>
              <Tabs activeName="tab1">
                ...
                <TabPane title="标签二" disabled name="tab2">
                  标签二的内容
                </TabPane>
                <TabPane title="标签三" name="tab3">
                  标签三的内容
          ...
          <Space id="tabs_icon" dir="v">
            <Card bordered>
              <Tabs activeName="tab1">
                ...
                <TabPane title="标签二" name="tab2" icon={<FeatherCommand />}>
                  标签二的内容
                </TabPane>
                <TabPane title="标签三" name="tab3" icon={<FeatherSlack />}>
                  标签三的内容
                </TabPane>
              </Tabs>

              <Divider align="left">
                <Text type="primary">图标</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
          ...
          <Space id="tabs_card" dir="v">
            <Card bordered>
              ...
              <Divider align="left">
                <Text type="primary">卡片</Text>
              </Divider>
              <Paragraph type="secondary" spacing="extended">
                设置属性 <Text code>type</Text> 为 <Text code>card</Text>{' '}
                可以显示卡片样式，常用于容器顶部。
              </Paragraph>
          ...
          <Space id="tabs_extra" dir="v">
            <Card bordered>
              <Tabs
                activeName="tab1"
                append={<Button size="small">Append extra</Button>}
                prepend={<Button size="small">Prepend Extra</Button>}
              >
                <TabPane title="标签一" name="tab1">
                  标签一的内容
                </TabPane>
            ...
            <Card bordered>
              ...
              >
                <For each={data()}>
                  {(item: any) => {
                    return (
                      <TabPane title={item.title} name={item.name} closeable />
                    )
                  }}
                </For>
              </Tabs>
            ...
            <Card bordered>
              ...
              >
                <For each={data2}>
                  {(item: any) => {
                    return (
                      <TabPane title={item.title} name={item.name}>
                        {item.context}
                      </TabPane>
                    )
                  }}
